# =============================================================================
#
#  Full Integrated Script (Final Version 3.0):
...
# =============================================================================
#  PART 2: SIMULATE VNS EFFECT (USING SUSTAINED SUPPRESSION TEMPLATE)
# =============================================================================
...
# *** MODIFIED: Assume suppression remains at its peak to model a sustained effect ***
suppression_norm = np.array([0.0, 1.0, 1.0, 1.0])
hours = days * 24
