# =============================================================================
#
#  Full Integrated Script (Corrected & Zoomed):
#  - Implements proportional VNS suppression to ensure non-negativity.
#  - Simulation time is now set to 100 hours to focus on initial dynamics.
#
...
# =============================================================================
#  PART 2: SIMULATE VNS EFFECT (CORRECTED & ZOOMED)
# =============================================================================

print("\n--- Starting Part 2: Simulating VNS Effect (with Proportional Suppression) ---")

# 1) Build the v(t) temporal template
days = np.array([0, 42, 56, 84])
suppression_norm = np.array([0.0, 1.0, 0.052, 0.791])
hours = days * 24
v_interp = PchipInterpolator(hours, suppression_norm, extrapolate=False)
...
# *** MODIFIED: Simulation now ends at 100 hours to zoom in on initial dynamics ***
t_start, t_end = 0, 100
